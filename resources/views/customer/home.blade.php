            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-6">
                    ...
                    <div class="small-box bg-success">
                        ...
                        <a href="{{route('customer.orders.index', ['status'=> 'completed'])}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-4 col-6">
                    ...
                    <div class="small-box bg-warning">
                        ...
                        <a href="{{route('customer.orders.index', ['status'=> 'pending'])}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /.row -->
